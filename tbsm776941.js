...
var rid='19716a5ef58x04376363-xs3xelg';
$("style:eq(0)").append(`#d2 .roomh[onclick="rjoin('${rid}')"]{
background-size: 220% auto;border-radius: 2px !important;border: 1px solid #0000;
}`);
$("style:eq(0)").append(`#upro .roomh[onclick="rjoin('${rid}')"]{
background-image: url(https://up6.cc/2025/07/175166862425351.png); background-size: cover;color: #666666;
}`)
...
.nosel.d-flex.room.r19716a5ef58x04376363-xs3xelg .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
letter-spacing: 1px;
...
.nosel.d-flex.room.r19716a5ef58x04376363-xs3xelg.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.room.r19716a5ef58x04376363-xs3xelg .dots.mini.u-msg {
text-align: center;
...
.nosel.d-flex.room.r19716a5ef58x04376363-xs3xelg {
    background-image: url(https://up6.cc/2025/07/175159822811921.gif);
    background-size: cover;
    border-radius: 2px;
    display: inline-block;
...
.nosel.d-flex.room.r19716a5ef58x04376363-xs3xelg .u-topic.dots {
text-transform: uppercase;
...
#d2.tarab1 .label-primary{background-color:#b77c9a!important}#d2.tarab1 .bg{background-color:#b77c9a!important}#d2.tarab1 .uzr.d-flex.mm.hmsg{border-radius: 2px;background-color:#bbbbbb9e!important}#dpnl.tarab1{background-size: 100%;background-image: url(https://up6.cc/2025/07/175166862425351.png);background-color: #b2b2b2;  }#dpnl.tarab1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.tarab1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.tarab1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
background-image: url(https://up6.cc/2025/07/175166856475471.png);
    background-size: cover;
    border-radius: 15px 0px 15px 0px;
    display: inline-block;
}
...
#upro.tarab1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2025/07/175166232951281.png);
    background-size: 100%;
}
#mic.tarab1 #muteall {
    border-radius: 2px;
...
setInterval(function () {
    if (myroom == '19716a5ef58x04376363-xs3xelg') {
        if (tarab == false) {
            tarab = true;
...
#d2.tarab1{background-color:#fafafa !important;
background-image: url(https://up6.cc/2025/07/175166325168321.png);
    background-size: cover;
    border-radius: 15px 0px 15px 0px;
    display: inline-block;
}
...
`);var tarab = false;
setInterval(function () {
    if (myroom == '197cb46eea3x141d6685x-wt4n0m') {
        if (tarab == false) {
            tarab = true;
                $('#d0, #users, #d2, #mic, #settings, #rooms, #room, #d0, #chats, #d2bc, #muteall, #wall, #dpnl, #upro').addClass('tarab1');
		$('input, button.rsave.btn.btn-primary.fl, button.border.btn.label.label-success.fl.fa.fa-plus, button.blike.corner.btn.minix.btn-danger.fa.fa-heart, .fl.borderg, .fl.u-pic.fitimg, .dots, .tc, .label.fl.label-primary, .btn.btn-primary.u-nickc.fr.fa.fa-save, .modal-header.label-primary, .corner.border.label.label-primary,.head.d-flex.nosel.bg.fl, .rsave.btn.btn-primary.fr, .fa.fa-send.sndpm.fl.btn.btn-primary, .fr.fa.fa-share-alt.sndfile.fl.btn.btn-primary, .fr.fa.fa-share-alt.sndfilebc.fl.btn.btn-primary, .bdel.corner.btn.minix.btn-primary.fa.fa-times, .fa.fa-send.sndbc.fl.btn.btn-primary').addClass('tarab1');
