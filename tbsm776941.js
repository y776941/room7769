var rid='1908fac849axce5be241x-2ow16';
...
.nosel.d-flex.room.r197cb46eea3x141d6685x-wt4n0m {
    background-image: url(https://up6.cc/2024/07/172074089235181.gif);
...
#users.l7dah1 .nosel.ninr.fl.uzr.label.bg {
	...
	color: #ffffff;
	background-image: url(https://up6.cc/2025/07/175149157499711.png);
    background-size: cover;
}
#d0.l7dah1 .label-primary {
    border: 1px solid #4a4646 !important;
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2025/07/175149167711131.png);
    color: #ffffff;
    background-size: 100%;
}
...
box-shadow: 0 0 0px rgb(0 0 0), inset 0 0 14px rgb(0 0 0), 0 0 0 0px #000;
}
.fl.borderg.l7dah1 {
  border-radius:  10px 0 10px!important;
  border: 1px solid #bfbfbf;
